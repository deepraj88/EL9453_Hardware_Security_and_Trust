...
HD_PWD='/media/deepraj/Work/workspace/Lecture/Hardwar_security/homework/tiny-AES-c/aes_test/aes_test.runs/Cipher_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cipher_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cipher_0.tcl
