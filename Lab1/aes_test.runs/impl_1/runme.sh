...
HD_PWD='/media/deepraj/Work/workspace/Lecture/Hardwar_security/homework/tiny-AES-c/aes_test_3/aes_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log apatb_Cipher_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source apatb_Cipher_top.tcl -notrace
