...
HD_PWD='/media/deepraj/Work/workspace/Lecture/Hardwar_security/homework/tiny-AES-c/aes_test_3/aes_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log apatb_Cipher_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apatb_Cipher_top.tcl
