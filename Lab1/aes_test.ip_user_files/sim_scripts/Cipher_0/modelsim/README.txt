...
#
# Generated by export_simulation on Fri Jul 26 17:48:43 EDT 2019
#
################################################################################
...
'-reset_run' switch to the './Cipher_0.sh' script.

./Cipher_0.sh -reset_run
...
./Cipher_0.sh -noclean_files

For more information on the script, please type './Cipher_0.sh -help'.
